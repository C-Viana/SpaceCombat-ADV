...
public class Handler {
	...
	public LinkedList<GameObject> objectPlayer = new LinkedList<GameObject>(); //ADICIONA O JOGADOR
	public LinkedList<GameObjectB> object = new LinkedList<GameObjectB>(); //ADICIONA OS INIMIGOS
	public LinkedList<GameObjectC> item = new LinkedList<GameObjectC>(); //ADICIONA ITENS QUE AUXILIAM O JOGADOR
	public LinkedList<GameObjectD> laser = new LinkedList<GameObjectD>(); //ADICIONA CADA LASER GERADO AO ATIRAR
	public LinkedList<GameObjectE> enemylaser = new LinkedList<GameObjectE>(); //ADICIONA CADA LASER GERADO PELOS INIMIGOS
