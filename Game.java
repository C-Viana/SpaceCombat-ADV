...
public class Game extends Canvas implements Runnable {
	...
	//GAME LOOP TODO FLUXO O JOGO É ATUALIZADO E MANTIDO POR ESTE ALGORITMO
	public void run() {
	...
	public void tick() {
		...
		if(gameState == STATE.Game && !pause){
			...
			if(hitPoints <= 0){
				...
				try{
					Game.player.playerImg = ImageIO.read(getClass().getResource("/PlayerAlpha.png"));
				}catch (IOException e) { e.printStackTrace(); }
				camera = new Camera(0,-4000.0f+HEIGHT);
